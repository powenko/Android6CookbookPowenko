...
public class TutorialPart011OpenRenderer implements Renderer {
	private TutorialPart011Square square;
	//private TutorialPart007SmoothColoredSquare smoothSquare; // NEW LINE ADDED. 
	
	public TutorialPart011OpenRenderer(Context context) {
		// Initialize our square. 
		square = new TutorialPart011Square(context);
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		  ...
		  //  gl.glOrthof(-1, 1, -1 / ratio, 1 / ratio, 0.01f, 100.0f);
			...
			square.onSurfaceCreated(gl,config);
